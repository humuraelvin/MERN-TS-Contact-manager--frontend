...
const Home: React.FC = () => {
  return (
    <div>
      ...
      <div className="absolute flex flex-row w-full h-24 p-8 mb-10 bg-gray-500 rounded-lg cursor-pointer gap-28 hover:bg-cyan-500 mt-80">
        ...
        <button className="ml-10 text-5xl font-extrabold text-red-600">
          <MdDelete />
        </button>
      </div>
      <br />
      ...
      <div className="absolute flex flex-row w-full h-24 p-8 mb-10 bg-gray-500 rounded-lg cursor-pointer gap-28 mt-96 hover:bg-cyan-500">
